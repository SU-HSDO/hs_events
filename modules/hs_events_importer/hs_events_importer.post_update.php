...
/**
 * hs_events_importer.post_update.php
 */

/**
 * Change importer urls.
 */
function hs_events_importer_post_update_8_0_4() {
 ...
 */
function hs_events_importer_post_update_8_0_6() {
 ...
 */
function hs_events_importer_post_update_8_0_7_alpha1(){
  /** @var \Drupal\config_update\ConfigReverter $config_update */
  $config_update = \Drupal::service('config_update.config_update');
  $config_update->revert('migration', 'events_image_importer');
  $config_update->revert('migration', 'events_importer');
